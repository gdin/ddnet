...
MACRO_CONFIG_INT(ClOldChatSounds, cl_old_chat_sounds, 0, 0, 1, CFGFLAG_SAVE | CFGFLAG_CLIENT, "Swap the sounds of highlighted and regular chat messages like in older versions")
